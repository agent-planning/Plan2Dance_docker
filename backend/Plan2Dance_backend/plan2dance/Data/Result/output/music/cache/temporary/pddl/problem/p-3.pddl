...
(:init
   ...
   (= (beat-satisfy-times) 0)
	(at 1.235 (at-beat b0))
	(at 1.335 (not (at-beat b0)))
	(at 3.348 (at-beat b1))
	(at 3.448 (not (at-beat b1)))
	(at 5.299 (at-beat b2))
	(at 5.399 (not (at-beat b2)))
	(at 7.389 (at-beat b3))
	(at 7.489 (not (at-beat b3)))
...
(:goal (and
    ...
    (forall (?s - state) (preference p0 (best-rate ?s mid)))
